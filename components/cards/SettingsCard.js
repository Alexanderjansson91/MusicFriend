...
const AddNewSongCard = (props) => {
    ...
    return (
        ...
        />
            ...
            <View >
                <TouchableOpacity style={styles.pickSongButton} onPress={props.pickImageClick}>
                    <View style={styles.pickSongView}>
                        <Text style={styles.pickNewSong}>{props.pickImageText}</Text>
                        <Icon
                            name={props.iconPickImage}
                            style={styles.iconStyle}
                        />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.pickSongButton} onPress={props.resetPasswordClick}>
                    <View style={styles.pickSongView}>
                        <Text style={styles.pickNewSong}>{props.resetPasswordText}</Text>
                        <Icon
                            name={props.iconResetPassword}
                            style={styles.iconStyle}
                        />
                    </View>
                </TouchableOpacity>
